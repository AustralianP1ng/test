...
def lockedDoor():   # locked door path after staircase
    ...
    print('''Only to find yourself obstructed by a locked door.''')
...
def checkChoice2a(choice2a):    # Goes back to the Entrance Hall
    if choice2a == 1:
        entranceChoice()
...
like the voice of a distant crowd. Halfway down the hall, 
you notice a door slightly ajar on your right,
...
As you turn to the final entry, the ink begins to bleed off the page, 
forming the words:
''')
